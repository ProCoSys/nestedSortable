    ...
    $.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        _mouseStop: function (event) {
            ...
            if (this.options.dropCallBack !== null) {
                ...
                var self = this;
                var item = $(self.domPosition.parent.lastElementChild).attr("id");
                var toItem = $(self.placeholder).parents("li").first().attr("id");

                setTimeout(function() {
                    var e = {
                        item: item,
                        toItem: toItem,
                        hierarchy: self.toHierarchy()
                    };

                    self.options.dropCallBack(e);
                }, 500);                
            }
        },
